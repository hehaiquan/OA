...
L.Editable = L.Class.extend({
    ...
    /*zjl进行了样式修改，支持快速修改样式*/
    startPolyline: function (opts,latlng) {
    ...
    startPolygon: function (opts,latlng) {
        var polygon = this.createPolygon([], opts || {});
    ...
    startMarker: function (opts,latlng) {
    ...
    createPolyline: function (latlngs, opts) {
        var _opts = L.extend({ editOptions: { editTools: this } }, opts);
        var line = new this.options.polylineClass(latlngs,_opts);
        this.fireAndForward('editable:created', {layer: line});
        return line;
    },

    createPolygon: function (latlngs, opts) {
        var _opts = L.extend({ editOptions: { editTools: this } }, opts);
        var polygon = new this.options.polygonClass(latlngs, _opts);
    ...
    createMarker: function (latlng, opts) {
        var _opts = L.extend({ editOptions: { editTools: this } }, opts);
        var marker = new this.options.markerClass(latlng, _opts);
