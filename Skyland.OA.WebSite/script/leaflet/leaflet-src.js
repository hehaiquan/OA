/*
 ...
 line2723:修改了瓦片加载方式，跳过13,14级-----2014/12/18---张吉踉
 line3088:修改了wms的请求投影方式------2014/12/18-----张吉踉
*/
...
L.TileLayer = L.Class.extend({
	...
	_update: function () {
		...
		if ((map.options.isYX===false)&&(zoom == 13 || zoom == 14)) return;
...
L.TileLayer.WMS = L.TileLayer.extend({
	...
	onAdd: function (map) {
		...
		this.wmsParams[projectionKey] = "EPSG:4610";
