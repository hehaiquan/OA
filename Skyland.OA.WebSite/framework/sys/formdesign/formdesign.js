...
$.iwf.formdesign = new function () {
    ...
    function regeditForm(node) {
        ...
        win.load("framework/sys/formdesign/formedit.html", function () {
...
$.iwf.formdesign.datasourceManage = function (QueryConfig, callback) {
    ...
    win.load("framework/sys/formdesign/querydesign.html", function () {
...
$.fn.iwfHtmlDesign = function (options) {
    ...
    var table = $('<table style="width:100%;" border="0" cellspacing="0" cellpadding="0"></table>').appendTo(root);
