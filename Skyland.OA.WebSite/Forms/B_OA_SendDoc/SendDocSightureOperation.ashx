<%@ WebHandler Language="C#" Class="SendDocSightureOperation" %>
...
public class SendDocSightureOperation : Page
{
    ...
    public string SaveSighture(string columnName)
    {
        ...
        try
        {
            ...
            //删除原来的文件和相关数据
            DeleteSendDoc(mRecordID, "SendDoc", mFieldName,mUserName, tran);
            ...
            //var thumbnail = img.GetThumbnailImage(460, 70, null, IntPtr.Zero);
            ...
            //sighture_edit.tableName = "SendDoc";
