$.iwf.register(new function () {
    var me = this;
    this.options = { key: 'bigEventsSee' };
    this.show = function (module, root) {
        $.Biz.bigEventsSee.show(module, root);
    }
});


$.Biz.bigEventsSee = new function () {
    var self = this;
    var root;
    self.data = null;
    //var wftool;
    ...
    this.show = function (module, _root) {
        ...
        root.load("models/OA_Notice/BigEventsSee.html", function () {
            loadData();
            //tab设置
    ...
    function loadData() {
        $.fxPost("DocumentCenterSvc.data?action=GetNoticeByDocumentType", { getTypeName: 'bigEvents' }, function (ret) {
            if (!ret.success) {
                  $.Com.showMsg(ret.msg);
                return;
            }
