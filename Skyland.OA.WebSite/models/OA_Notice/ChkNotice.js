$.iwf.register(new function () {
    var me = this;
    this.options = { key: 'chkNotice' };
    this.show = function (module, root) {
        $.Biz.chkNotice.show(module, root);
    }
});
...
$.Biz.chkNotice = new function () {
    ...
    this.show = function (module, _root) {
        ...
        root.load("models/OA_Notice/ChkNotice.html", function () {
            loadData();
            //tab设置
    ...
    function loadData() {
        $.fxPost("DocumentCenterSvc.data?action=GetCheckNoticeList", { getTypeName: 'tongzhigonggao' }, function (ret) {
