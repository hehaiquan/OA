$.iwf.register(new function () {
    var me = this;
    this.options = { key: 'chkPublish' };
    this.show = function (module, root) {
        $.Biz.chkPublish.show(module, root);
    }
});



$.Biz.chkPublish = new function () {
    var self = this;
    var root;
    self.data = null;
    var models = {};
    ...
    this.show = function (module, _root) {
        ...
        root.load("models/OA_Notice/ChkPublish.html", function () {
            loadData();
            //tab设置
    ...
    function loadData() {
        $.fxPost("DocumentCenterSvc.data?action=GetCheckNoticeList", { getTypeName: 'xinxifabu' }, function (ret) {
