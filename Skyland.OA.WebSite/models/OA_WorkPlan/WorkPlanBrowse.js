//浏览内容
$.Biz.WorkPlanBrowseContent = function (id) {
    ...
    this.show = function (module, root) {
        ...
        root.load("models/OA_WorkPlan/WorkPlanBrowse.html", function () {
...
//新闻公告浏览窗口
$.Biz.WorkPlanBrowseWin = function (id, callback) {
    var model = new $.Biz.WorkPlanBrowseContent(id);
    var opts = { title: '工作计划浏览',mask:true, height: 500, width: 600 };
