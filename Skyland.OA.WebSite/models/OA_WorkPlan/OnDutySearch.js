$.iwf.register(new function () {
    var me = this;
    this.options = { key: 'OnDutySearch' };
    this.show = function (module, root) {
        $.Biz.OnDutySearch.show(module, root);
    }
});



$.Biz.OnDutySearch = new function () {
    var self = this;
    var root;
    self.data = null;
    var models = {};
    ...
    this.show = function (module, _root) {
        ...
        root.load("models/OA_WorkPlan/OnDutySearch.html", function () {
    ...
    function loadData(where) {
        var par = {
            ...
            where: where,
            order: "department,startTime desc"
        }
