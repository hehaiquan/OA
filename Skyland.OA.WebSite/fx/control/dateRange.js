...
define(function () {
    ...
    function DateRangePicker($select) {
        ...
        function locationByButton($dateRangePicker) {
            //var y = $select.outerHeight();// $select.offset().top + $select.outerHeight();
            //var x = 5;
            $dateRangePicker.css({ "margin-top": $select.outerHeight() + 20 });



            ////if (window.screen.width >= 800) x = $select.offset().left;
            //$dateRangePicker.css({
            //    left: x,
            //    top: y,
            //});
        ...
        locationByButton(this.$dateRangePicker);
    ...
    DateRangePicker.prototype.showCustomDate = function () {
        ...
        if (this.onSet) this.onSet(this.formatDate(this.startDate()), this.formatDate(this.endDate()));  //事件回调
