...
{
    [Serializable]
    [DataTableInfo("B_OA_Supervision_Notice", "")]
    public class B_OA_Supervision_Notice : QueryInfo
    {
        /// <summary>
        /// 主键
        /// </summary>
        [DataField("id", "B_OA_Supervision_Notice", false)]
        public int id
        {
            get { return _id; }
            set { _id = value; }
        ...
        /// 年
        /// </summary>
        [DataField("year", "B_OA_Supervision_Notice")]
        public string year
        {
            get { return _year; }
            set { _year = value; }
        ...
        /// 号
        /// </summary>
        [DataField("code", "B_OA_Supervision_Notice")]
        public string code
        {
            get { return _code; }
            set { _code = value; }
        ...
        ///  承办人名字
        /// </summary>
        [DataField("assistManName", "B_OA_Supervision_Notice")]
        ...
        ///  承办人ID
        /// </summary>
        [DataField("assistManId", "B_OA_Supervision_Notice")]
        ...
        ///  填空
        /// </summary>
        [DataField("space1", "B_OA_Supervision_Notice")]
        ...
        ///  填空
        /// </summary>
        [DataField("space2", "B_OA_Supervision_Notice")]
        ...
        ///  填空
        /// </summary>
        [DataField("space3", "B_OA_Supervision_Notice")]
        ...
        ///  填空
        /// </summary>
        [DataField("space4", "B_OA_Supervision_Notice")]
        ...
        ///  承办人ID
        /// </summary>
        [DataField("createDate", "B_OA_Supervision_Notice")]
        ...
        ///  领取人签名
        /// </summary>
        [DataField("receiveManSighture", "B_OA_Supervision_Notice")]
        ...
        ///关联ID
        /// </summary>
        [DataField("relationCaseId", "B_OA_Supervision_Notice")]
        ...
        ///事件ID
        /// </summary>
        [DataField("caseid", "B_OA_Supervision_Notice")]
        ...
        /// 签发人ID
        /// </summary>
        [DataField("issuerManId", "B_OA_Supervision_Notice")]
        ...
        /// 签发人名字
        /// </summary>
        [DataField("issuerManName", "B_OA_Supervision_Notice")]
        ...
        /// 催办日期
        /// </summary>
        [DataField("supervisionDate", "B_OA_Supervision_Notice")]
